...
== The Problem
Many server-side languages emit RFC3339 date formats (e.g. Ruby and Python JSON encoders) 
but the standard Javascript Date object cannot parse these values, making client-side scripting
involving dates a pain.
...
== Obtaining
 rfc3339date.js is hosted on [http://github.com/tardate/rfc3339date.js]
 Downloads available from [http://github.com/tardate/rfc3339date.js/downloads]
...
fall through to the default Date.parse implamentation:
   ...
   // NB: if handled by the default Javascript Date.parse implementaitn, this
...
* ISO 8601 Durations (e.g. P0003-06-04T12:30:05), 
* ISO 8601 Time intervals (e.g. 2007-03-01T13:00:00Z/2008-05-11T15:30:00Z)
