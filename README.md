...
and data transfer formats (e.g. [ATOM](https://en.wikipedia.org/wiki/Atom_(web_standard)))
emit
[RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) /
[ISO 8601](https://en.wikipedia.org/wiki/ISO_8601)
...
rfc3339date.js is hosted on [GitHub](https://github.com/tardate/rfc3339date.js),
with downloads available from <https://github.com/tardate/rfc3339date.js/downloads>.
